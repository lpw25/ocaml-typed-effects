...
and effect_infos
 ...
 fun handler i ppf x ->
  ...
  handler i ppf x.peff_handler

and effect_declaration i ppf x =
  effect_infos (fun i ppf x -> option i effect_handler ppf x) i ppf x
